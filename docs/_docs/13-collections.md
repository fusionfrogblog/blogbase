...
The theme has been built with collections in mind and you will find [several examples]({{ "/collection-archive/"  }}) on the demo site ([portfolio]({{ "/portfolio/"  }}), [recipes]({{ "/recipes/"  }}), pets). 
...
![portfolio collection example]({{ "/assets/images/mm-portfolio-collection-example.jpg"  }})