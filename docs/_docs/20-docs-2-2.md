...
<figure>
  <img src="{{ '/assets/images/paragraph-indent.png'  }}" alt="screen shot of paragraphs with default indent style set">
...
<figure>
  <img src="{{ '/assets/images/paragraph-no-indent.png'  }}" alt="screen shot of paragraphs with indent style disabled">
